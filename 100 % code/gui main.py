...
root.title("Body weight analysis Using Machine Learning")
w,h = root.winfo_screenwidth(),root.winfo_screenheight()

image2 =Image.open('y9.jpg')
...
w = tk.Label(root, text="Body weight analysis Using Machine Learning",width=100,background="purple",height=2,font=("Times new roman",19,"bold"))
w.place(x=70,y=15)
...
wlcm=tk.Label(root,text="......Welcome to Body weight analysis  System ......",width=95,height=3,background="purple",foreground="black",font=("Times new roman",22,"bold"))
